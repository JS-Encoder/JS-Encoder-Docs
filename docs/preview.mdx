...
<img style={{width: "500px"}} src="http://img-cdn.jsencoder.cn/docs/images/screen-fold.png-toWebp.webp"/>

点击上方正中间的半透明箭头展开菜单栏，有两个按钮：刷新和退出全屏。

<img style={{width: "500px"}} src="http://img-cdn.jsencoder.cn/docs/images/screen-unfold.png-toWebp.webp"/>
...
<img style={{width: "700px"}} src="http://img-cdn.jsencoder.cn/docs/images/preview-error.png-toWebp.webp"/>
